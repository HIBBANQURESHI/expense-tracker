  ...
  return (
    ...
    <div className="bg-white text-black">
      ...
      <Row>
        ...
        <h1 className="text-center text-black">Expense Management System</h1>
        <Col md={{ span: 6, offset: 3 }}>
          ...
          <Form>
            ...
            <div style={{width: "100%", display: "flex" , alignItems:"center", justifyContent:"center", flexDirection: "column"}} className="mt-4">
              ...
              <p className="mt-3 px-" style={{color: "black"}}>Already have an account? <Link to="/login" className="text-blue-800 lnk" >Login</Link></p>
            </div>
          </Form>
        </Col>
      </Row>
