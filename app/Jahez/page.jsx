...
const Expense = () => {
  ...
  const fetchSales = async () => {
    try {
      const response = await axios.get("http://localhost:4000/api/jahez");
  ...
  const fetchSummary = async () => {
    try {
      const response = await axios.get("http://localhost:4000/api/jahez/summary/total");
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:4000/api/jahez/${id}`);
