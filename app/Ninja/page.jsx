...
const Expense = () => {
  ...
  const fetchSales = async () => {
    try {
      const response = await axios.get("https://akc-expense-server.vercel.app/api/ninja");
  ...
  const fetchSummary = async () => {
    try {
      const response = await axios.get("https://akc-expense-server.vercel.app/api/ninja/summary/total");
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://akc-expense-server.vercel.app/api/ninja/${id}`);
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Ninja Delivery Management</h1>
      ...
      <div className="w-full max-w-6xl mb-6 space-y-4">
        ...
        <Link href="/CreateNinja" className="block">
